...
import com.saarthi.app.core.designsystem.SaarthiShapes
...
fun VoiceHomeScreen(navController: NavHostController, viewModel: VoiceViewModel = hiltViewModel()) {
    ...
    LaunchedEffect(Unit) {
        viewModel.say("Hello. I am Saarthi. Tap the circle and talk to me.")
    }
        ...
        modifier = Modifier
            ...
            .background(
                Brush.radialGradient(
                    colors = listOf(SaarthiColors.BrandGreenLight.copy(alpha = 0.10f), Color.Transparent),
                ),
            ),
    ) {
        Column(
            ...
            VoiceOrb(listening = listening, onClick = { viewModel.startListening() })
            ...
            if (heard.isNotBlank()) {
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .background(MaterialTheme.colorScheme.surface, SaarthiShapes.large)
