...
android {
    namespace = "com.lifeos.app.core.ai"
    compileSdk = 35
...
dependencies {
    ...
    // Real org.json impl for JVM unit tests — android.jar's org.json classes
    // are stubs that throw "Stub!" outside Robolectric/a real device.
    testImplementation(libs.orgJsonLib)
}
