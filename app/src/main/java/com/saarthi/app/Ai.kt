...
object Groq {
    ...
    fun understand(key: String, text: String, contactNames: List<String>, lang: String): AiIntent? {
        ...
        val sys = buildString {
            ...
            append("volume_up, volume_down, volume_max, medicine_taken, open_medicines, help, none. ")
            ...
            append("reply = one short, warm sentence to say back, in the SAME language the user spoke. ")
            append("Keep reply very simple and slow-friendly. Do not add anything outside the JSON.")
        }
